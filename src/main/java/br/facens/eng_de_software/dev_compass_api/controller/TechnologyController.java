...
public class TechnologyController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TechnologyResponseDto> getById(@PathVariable String id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TechnologyResponseDto> update(@PathVariable String id, @RequestBody TechnologyEditorDto editorDto) throws Exception {
